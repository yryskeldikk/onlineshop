-- -----------------------------------------------------
-- Schema onlineshop-db
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `onlineshop-db`;

CREATE SCHEMA `onlineshop-db`;
USE `onlineshop-db` ;

-- -----------------------------------------------------
-- Table `onlineshop-db`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `onlineshop-db`.`product_category` (
...
-- -----------------------------------------------------
-- Table `onlineshop-db`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `onlineshop-db`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
